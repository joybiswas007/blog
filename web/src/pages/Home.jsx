      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex items-center gap-2.5">
            <span className="text-[var(--color-accent-primary)] font-mono font-bold select-none text-base">/</span>
            <span className="text-xs text-[var(--color-text-secondary)] group-hover:text-[var(--color-text-primary)] transition-colors duration-150">
              Press <kbd className="font-mono bg-[var(--color-editor-bg)] border border-[var(--color-panel-border)] px-1.5 py-0.5 rounded text-[var(--color-accent-primary)] font-bold text-xs select-none">/</kbd> to search posts...
            </span>
          </div>

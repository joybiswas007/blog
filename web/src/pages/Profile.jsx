  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-[75vh] font-mono text-xs text-[var(--color-text-primary)] space-y-8 select-none py-8 sm:py-12 animate-[fadeIn_0.2s_ease-out]">
        {/* ASCII Logo with responsive font size to prevent horizontal scrolling */}
        <pre className="text-[var(--color-accent-primary)] font-bold text-[7px] sm:text-[10px] md:text-xs leading-tight select-none overflow-x-auto whitespace-pre max-w-full text-center px-4">
          {asciiLogo}
        </pre>
